...
namespace TapInMotion.Controllers
{
    public class AdministratorsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Administrator.Include(a => a.School);
        ...
        public async Task<IActionResult> Create([Bind("AdministratorID,SchoolID,Name,StartDate")] Administrator administrator)
        {
            ...
            ViewData["SchoolID"] = new SelectList(_context.School, "SchoolID", "Alias", administrator.SchoolID);
            return View(administrator);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdministratorID,SchoolID,Name,StartDate")] Administrator administrator)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Administrator'  is null.");
            }
            var administrator = await _context.Administrator.FindAsync(id);
            if (administrator != null)
            {
